...
import { SafeAreaView, FlatList, StatusBar, StyleSheet, Text, View, Button } from 'react-native';
...
const TasksView = ({ navigation }) => {
  ...
  const renderTaskCard = ({ item }) => <TaskCard name={item.name} duration={item.duration} />;

  return (
    <SafeAreaView>
      <StatusBar />
      <Button title="Add Task" onPress={() => navigation.navigate('Add a Task')} />
      <FlatList
