...
const SchedulePickTimeSlotView = ({navigation, route}) => {
    ...
    const RecommendationCards = () => {
        return (ranked_recommendations.slice((page - 1) * 4, page * 4).map((rec) => 
    ...
    return (
        <SafeAreaView>
            ...
            <View style={styles.childView}> 
                ...
                <Button title="See more recs" onPress={() => (page !== Math.trunc(ranked_recommendations.length / 4) + 1) ? setPage(page + 1): setPage(page)} style={styles.validButton}/>
            </View>
